...
set_property -dict {PACKAGE_PIN G13 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[0]}]
set_property -dict {PACKAGE_PIN B11 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[1]}]
set_property -dict {PACKAGE_PIN A11 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[2]}]
set_property -dict {PACKAGE_PIN D12 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[3]}]
set_property -dict {PACKAGE_PIN D13 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[4]}]
set_property -dict {PACKAGE_PIN B18 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[5]}]
set_property -dict {PACKAGE_PIN A18 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[6]}]
set_property -dict {PACKAGE_PIN K16 IOSTANDARD LVCMOS33} [get_ports {ADC_DATA[7]}]

##Pmod Header JB

#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { CIS_SP }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { CIS_SP_GND }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { CIS_CLK }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { CIS_CLK_GND }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { SCOPE_SYNC }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { SCOPE_SYNC_GND }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
...
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports USB_CLK]
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets USB_CLK_IBUF]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports CIS_MODE]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports CIS_CLK]
set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports CIS_SP]
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports CIS_LED_BLUE]
set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports CIS_LED_GREEN]
set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports CIS_LED_RED]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports SCOPE_SYNC]

##Pmod Header JD

set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[0]}]
set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[1]}]
set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[2]}]
set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[3]}]
set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[4]}]
set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[5]}]
set_property -dict {PACKAGE_PIN H2 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[6]}]
set_property -dict {PACKAGE_PIN G2 IOSTANDARD LVCMOS33} [get_ports {USB_DATA[7]}]
